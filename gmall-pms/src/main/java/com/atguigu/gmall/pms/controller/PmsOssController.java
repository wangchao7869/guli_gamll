...
public class PmsOssController {
    ...
    String accessId = "LTAI4GKwG325Mms34ap7FzE2"; // 请填写您的AccessKeyId。
    String accessKey = "TI5MRPlZYjNiwqGF2DBm71BDfgzifJ"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "chao-gmall"; // 请填写您的 bucketname 。
